...
data_dir = project_dir + "/Self_frames/"
...
seq_frames_dir = "/home/ipcvg/tensorflow_enet/roimgs/"
seq_frame_paths = []
...
results_dir = model.project_dir + "/all_frame/"
...
with tf.Session() as sess:
    ...
    saver.restore(sess, project_dir + "training_logs/model_4/checkpoints/model_4_epoch_90.ckpt")
    ...
    for step in range(no_of_batches):
        ...
        for i in range(batch_size):
            ...
            pred_path = results_dir + img_name

            overlayed_img =pred_img_color
...
out = cv2.VideoWriter(results_dir + "final.avi", fourcc,
            30.0, (img_width, img_height))
