...
# with modifications from https://www.pyimagesearch.com/2015/12/21/increasing-webcam-fps-with-python-and-opencv/
    def __init__(self, src, width, height):
        ...
        #self.stream = cv2.VideoCapture("rtsp://admin:hkzlbf111@192.168.30.64/Streaming/Channels/1")  # rtsp取流
        self.stream = cv2.VideoCapture(src)  # 原始相机取流
        #self.stream = cv2.VideoCapture('C:/Users/admin/PycharmProjects/pythonProject/w2e.mp4')  # 原始相机取流
